...
public class JDBCConnectionPool {
    ...
    public void connect() {
        if (dataSource == null || dataSource.isClosed()) {
            ...
            if (sqlInit != null)
                dataSource.setConnectionInitSql(sqlInit);
            if (sqlTest != null)
                dataSource.setConnectionTestQuery(sqlTest);
            if (timeout != null)
    ...
    public static final class Builder
        extends NestedBuilder<JDBCConnectionPools, JDBCConnectionPool> {
        ...
        @Nonnull
        public Builder withMaximalPoolsSize(
            @Nonnull final int maximalPoolSize) {
