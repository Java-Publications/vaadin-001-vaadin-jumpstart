...
public class LoginServiceImplTest extends BaseDDITest {
  ...
  @Test
  public void validateUser001() throws Exception {
  ...
  @Test
  public void validateUser002() throws Exception {
    final Optional<User> user = DI.activateDI(LoginService.class)
        .loadUser(null, "XX");
    Assert.assertFalse(user.isPresent());
  }
  ...
  @Test
  public void validateUser003() throws Exception {
    final Optional<User> user = DI.activateDI(LoginService.class)
        .loadUser("XX", null);
    Assert.assertFalse(user.isPresent());
  }
  ...
  @Test
  public void validateUser004() throws Exception {
    final Optional<User> user = DI.activateDI(LoginService.class)
        .loadUser("admin", "");
  ...
  @Test
  public void validateUser005() throws Exception {
    final Optional<User> user = DI.activateDI(LoginService.class)
        .loadUser("", "admin");
    Assert.assertEquals(User.NO_USER, user.get());
  }
  ...
  @Test
  public void validateUser006() throws Exception {
    final Optional<User> user = DI.activateDI(LoginService.class)
