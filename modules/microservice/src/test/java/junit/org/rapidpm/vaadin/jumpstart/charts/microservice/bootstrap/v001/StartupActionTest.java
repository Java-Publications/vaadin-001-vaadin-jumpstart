...
public class StartupActionTest extends MicroserviceBaseTest {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(StartupTestAction.class);
  ...
  public void test002() throws Exception {
    ...
    Assert.assertEquals(StartupTestAction.class.getSimpleName(), response.readEntity(String.class));
  }
  ...
  public static class StartupTestAction implements Main.MainStartupAction {
    ...
    public void execute(Optional<String[]> args) {
      ...
      System.setProperty(START_UP_ACTION, this.getClass().getSimpleName());
